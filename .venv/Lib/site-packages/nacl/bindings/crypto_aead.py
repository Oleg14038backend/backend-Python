...
crypto_aead_aegis256_MESSAGEBYTES_MAX: int = lib.crypto_aead_aegis256_messagebytes_max()
...
def crypto_aead_aegis256_encrypt(
    ...
    mlen = len(message)
        ...
        isinstance(nonce, bytes) and len(nonce) == crypto_aead_aegis256_NPUBBYTES,
        "Nonce must be a {} bytes long bytes sequence".format(
...
def crypto_aead_aegis128l_encrypt(
    ...
    mlen = len(message)
        ...
        isinstance(nonce, bytes) and len(nonce) == crypto_aead_aegis128l_NPUBBYTES,
        "Nonce must be a {} bytes long bytes sequence".format(
...
def crypto_aead_aes256gcm_encrypt(
    ...
    mlen = len(message)
        ...
        isinstance(nonce, bytes) and len(nonce) == crypto_aead_aes256gcm_NPUBBYTES,
        "Nonce must be a {} bytes long bytes sequence".format(
